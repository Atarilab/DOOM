...
if __name__ == '__main__':
    ...
    while True:       
        ...
        cmd.motor_cmd[go2.LegID["FL_0"]].kp = 10.0 # Poinstion(rad) control kp gain
        cmd.motor_cmd[go2.LegID["FL_0"]].dq = 0.0  # Taregt angular velocity(rad/ss)
        cmd.motor_cmd[go2.LegID["FL_0"]].kd = 1.0  # Poinstion(rad) control kd gain
        cmd.motor_cmd[go2.LegID["FL_0"]].tau = 0.0 # Feedforward toque 1N.m

        # Poinstion(rad) control, set RL_0 rad
        cmd.motor_cmd[go2.LegID["FL_1"]].q = 0.8  # Taregt angular(rad)
        cmd.motor_cmd[go2.LegID["FL_1"]].kp = 10.0 # Poinstion(rad) control kp gain
        cmd.motor_cmd[go2.LegID["FL_1"]].dq = 0.0  # Taregt angular velocity(rad/ss)
        cmd.motor_cmd[go2.LegID["FL_1"]].kd = 1.0  # Poinstion(rad) control kd gain
        cmd.motor_cmd[go2.LegID["FL_1"]].tau = 0.0 # Feedforward toque 1N.m

        # Poinstion(rad) control, set RL_0 rad
        cmd.motor_cmd[go2.LegID["FL_2"]].q = -1.9  # Taregt angular(rad)
        cmd.motor_cmd[go2.LegID["FL_2"]].kp = 10.0 # Poinstion(rad) control kp gain
        cmd.motor_cmd[go2.LegID["FL_2"]].dq = 0.0  # Taregt angular velocity(rad/ss)
        cmd.motor_cmd[go2.LegID["FL_2"]].kd = 1.0  # Poinstion(rad) control kd gain
        ...
        cmd.motor_cmd[go2.LegID["FR_0"]].kp = 10.0 # Poinstion(rad) control kp gain
        cmd.motor_cmd[go2.LegID["FR_0"]].dq = 0.0  # Taregt angular velocity(rad/ss)
        cmd.motor_cmd[go2.LegID["FR_0"]].kd = 1.0  # Poinstion(rad) control kd gain
        cmd.motor_cmd[go2.LegID["FR_0"]].tau = 0.0 # Feedforward toque 1N.m

        # Poinstion(rad) control, set RL_0 rad
        cmd.motor_cmd[go2.LegID["FR_1"]].q = 0.8  # Taregt angular(rad)
        cmd.motor_cmd[go2.LegID["FR_1"]].kp = 10.0 # Poinstion(rad) control kp gain
        cmd.motor_cmd[go2.LegID["FR_1"]].dq = 0.0  # Taregt angular velocity(rad/ss)
        cmd.motor_cmd[go2.LegID["FR_1"]].kd = 1.0  # Poinstion(rad) control kd gain
        cmd.motor_cmd[go2.LegID["FR_1"]].tau = 0.0 # Feedforward toque 1N.m

        # Poinstion(rad) control, set RL_0 rad
        cmd.motor_cmd[go2.LegID["FR_2"]].q = -1.9  # Taregt angular(rad)
        cmd.motor_cmd[go2.LegID["FR_2"]].kp = 10.0 # Poinstion(rad) control kp gain
        cmd.motor_cmd[go2.LegID["FR_2"]].dq = 0.0  # Taregt angular velocity(rad/ss)
        cmd.motor_cmd[go2.LegID["FR_2"]].kd = 1.0  # Poinstion(rad) control kd gain
        ...
        cmd.motor_cmd[go2.LegID["RL_1"]].kp = 10.0 # Poinstion(rad) control kp gain
        cmd.motor_cmd[go2.LegID["RL_1"]].dq = 0.0  # Taregt angular velocity(rad/ss)
        cmd.motor_cmd[go2.LegID["RL_1"]].kd = 1.0  # Poinstion(rad) control kd gain
        cmd.motor_cmd[go2.LegID["RL_1"]].tau = 0.0 # Feedforward toque 1N.m

        # Poinstion(rad) control, set RL_0 rad
        cmd.motor_cmd[go2.LegID["RL_2"]].q = -1.9  # Taregt angular(rad)
        cmd.motor_cmd[go2.LegID["RL_2"]].kp = 10.0 # Poinstion(rad) control kp gain
        cmd.motor_cmd[go2.LegID["RL_2"]].dq = 0.0  # Taregt angular velocity(rad/ss)
        cmd.motor_cmd[go2.LegID["RL_2"]].kd = 1.0  # Poinstion(rad) control kd gain
        ...
        cmd.motor_cmd[go2.LegID["RR_0"]].kp = 10.0 # Poinstion(rad) control kp gain
        cmd.motor_cmd[go2.LegID["RR_0"]].dq = 0.0  # Taregt angular velocity(rad/ss)
        cmd.motor_cmd[go2.LegID["RR_0"]].kd = 1.0  # Poinstion(rad) control kd gain
        cmd.motor_cmd[go2.LegID["RR_0"]].tau = 0.0 # Feedforward toque 1N.m

        # Poinstion(rad) control, set RL_0 rad
        cmd.motor_cmd[go2.LegID["RR_1"]].q = 1.0  # Taregt angular(rad)
        cmd.motor_cmd[go2.LegID["RR_1"]].kp = 10.0 # Poinstion(rad) control kp gain
        cmd.motor_cmd[go2.LegID["RR_1"]].dq = 0.0  # Taregt angular velocity(rad/ss)
        cmd.motor_cmd[go2.LegID["RR_1"]].kd = 1.0  # Poinstion(rad) control kd gain
        cmd.motor_cmd[go2.LegID["RR_1"]].tau = 0.0 # Feedforward toque 1N.m
        
        # Poinstion(rad) control, set RL_0 rad
        cmd.motor_cmd[go2.LegID["RR_2"]].q = -1.9  # Taregt angular(rad)
        cmd.motor_cmd[go2.LegID["RR_2"]].kp = 10.0 # Poinstion(rad) control kp gain
        cmd.motor_cmd[go2.LegID["RR_2"]].dq = 0.0  # Taregt angular velocity(rad/ss)
        cmd.motor_cmd[go2.LegID["RR_2"]].kd = 1.0  # Poinstion(rad) control kd gain
