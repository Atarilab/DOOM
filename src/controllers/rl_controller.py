...
class RLHumanoidLocomotionVelocityController(BaseRLLocomotionController):
    """
    ...
    def register_observations(self):
        ...
        Lambda is used to get the latest value from the class variables.
        """
        from state_manager.observations import phase
        # self.obs_manager.register("lin_vel_b", ObsTerm(lin_vel_b))
        ...
        self.obs_manager.register(
            ...
            ObsTerm(
                velocity_commands,
                params={"velocity_commands": lambda: self.velocity_commands, "scale": self.cmd_scale},
            ),
        )
        self.obs_manager.register(
            "joint_pos",
        ...
        self.obs_manager.register(
            ...
            ObsTerm(
                phase, 
                params={"counter": lambda: self.counter, "period": self.period, "control_dt": self.control_dt}
            )
        )
