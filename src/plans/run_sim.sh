...
# Usage (inside Docker):
#   bash src/plans/run_sim.sh           → rank-0 (best cost)
...
#   rank0 .. rank4
#   diverse0_strong-left-lead
#   diverse1_front-heavy
#   diverse2_symmetric-moderate
#   diverse3_symmetric-best
#   diverse4_right-lateral
