...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution([FindPackageShare("g1_description"), "urdf", description_file]),
            " ",
            "prefix:=",
            prefix,
        ]
    ...
    nodes.append(
        Node(
            ...
            name="rviz2",
            output="screen",
            arguments=["-d", os.path.join(get_package_share_directory("g1_description"), "config", "g1_rviz.rviz")],
        )
    )
